...
ax.plot(clients, final_accuracies,  "o-", color=tab_colours[1], lw=2, ms=10, label="FedAvg with 500 obs. per device, 2 local epochs, 5 rounds")
ax.axhline(97.77, ls="-", lw=2, label="Centralized learning with 5000 obs, 10 epochs")
ax.set_ylim(93, 99)
ax.legend()
ax.grid()
fig.savefig("reports/imgs/scaling.pdf")
