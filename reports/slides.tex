	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{itemize}
				...
				%\item One of the early adoptions was by Google seeking to improve word recommendation on Android.
				\item Litterature often benchmarks on central compute clusters.
				\item We seek to create more true to nature experiments, monitoring the effect of physical hardware.
			\end{itemize}
		\end{column}
		\begin{column}{.5\textwidth}
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{itemize}
				...
				\item Find the key hyperparameters of the FedAvg algorithm
			...
			\begin{itemize}
				...
				\item One key parameter $\alpha$
					\begin{itemize}
						...
						\item $\alpha \to \infty$ leadsto balance
						\item We observed $\alpha \geq 100$ was more balanced than IID
					\end{itemize}
			\end{itemize}
		\end{column}
