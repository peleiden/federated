	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{itemize}
				...
				\item Pioneered by Google due to privacy and size of data sets 
				\item Litterature often benchmarks on central compute clusters
				\item How does physical devices impact results and perfomance
			\end{itemize}
		\end{column}
		\begin{column}{.5\textwidth}
		...
		\begin{column}{.5\textwidth}
			\begin{itemize}
				...
				\item Model
					...
					\end{itemize}
				\item Adam optimizer on clients
			...
			\begin{itemize}
				...
				\item One key parameter $\alpha$
					\begin{itemize}
						...
						\item Default value for alpha $\alpha=1$
					\end{itemize}
			\end{itemize}
		\end{column}
