...
\end{enumerate}
In general, these results show that model convergence is possible even though data is federated across devices, which is substantiated by the fact that running the $E=1$ experiment for longer resulted in a test performance plateau of 95\pro\ of centralised perfomance on this task; see Appendix Table \ref{app:centralised} for details.
\begin{figure}[htb!]
    \centering
