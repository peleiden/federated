...
\begin{table}[htb!]
    ...
    \begin{tabular}{llll}
       ...
       \hline
        ...
        0.01 & 1.0 & 100.0 & iid. \\
       \hline
        $9.9 \pm 0.2$ & $55.8 \pm 0.1$ & $56.5 \pm 0.9$ & $58.3 \pm 1.0$ \\
       ...
       \hline
        ...
        0 & 10 & 20 & 30 \\
       \hline
        $54.5 \pm 0.4$ & $52.0 \pm 2.9$ & $51.6 \pm 1.9$ & $42.9 \pm 0.3$ \\
\end{tabular}
    \caption{
...
\end{enumerate}
In general, these results show that model convergence is possible even though data is federated across devices, which is substantiated by the fact that is running the $E=1$ experiment for longer resulted in a test performance plateau of 95\pro\ of centralised performance on this task; see Appendix Table \ref{app:centralised} for details.
\begin{figure}[htb!]
    \centering
